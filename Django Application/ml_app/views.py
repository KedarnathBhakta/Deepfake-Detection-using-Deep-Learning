...
from .face_detection import FaceDetector  # Import our new face detection module
    ...
    def __getitem__(self,idx):
        ...
        for i,frame in enumerate(self.frame_extract(video_path)):
            try:
                ...
                print(f"Error in face detection during validation: {e}")
                pass
...
def predict_page(request):
    if request.method == "GET":
        ...
        # Always use just the filename for preview
        ...
        for i in range(sequence_length):
            ...
            try:
                ...
                print(f"Error converting frame {i} to RGB: {e}")
                continue
            ...
            try:
                ...
                print(f"Error saving preprocessed image {i}: {e}")
                continue

            # Face detection using our new module
            try:
                ...
                if frame_face.size == 0:
                    print(f"Empty face crop in frame {i}")
                    continue
                ...
                try:
                    ...
                    print(f"Error saving face crop {i}: {e}")
                    continue
                    
            except Exception as e:
                print(f"Error in face detection for frame {i}: {e}")
                continue
        ...
        try:
            ...
            context = {
                ...
                'original_video': production_video_name,  # This is just the filename
